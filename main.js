    var MemoryStats = function () {
      ...
      container.style.cssText =
        "width:180px;height:48px;opacity:0.9;cursor:pointer;overflow:hidden;z-index:10000;will-change:transform;";
      ...
      msGraph.style.cssText =
        "position:relative;width:174px;height:" +
        GRAPH_HEIGHT +
        "px;background-color:#0f0";
      msDiv.appendChild(msGraph);

      while (msGraph.children.length < 174) {
        var bar = document.createElement("span");
        bar.style.cssText =
          "width:1px;height:" +
          GRAPH_HEIGHT +
          "px;float:left;background-color:#131";
      ...
      var redrawGraph = function (dom, oHFactor, hFactor) {
        [].forEach.call(dom.children, function (c) {
          ...
          var newVal =
            GRAPH_HEIGHT - ((GRAPH_HEIGHT - cHeight) / oHFactor) * hFactor;
      ...
      return {
        ...
        update: function () {
          ...
          if (mbValue > redrawMBThreshold) {
            ...
            redrawGraph(
              msGraph,
              GRAPH_HEIGHT / redrawMBThreshold,
          ...
          updateGraph(
            msGraph,
            GRAPH_HEIGHT - mbValue * (GRAPH_HEIGHT / redrawMBThreshold),
            color
          );
        },
      };
